...
1. Install Python (3.10.11): https://www.python.org/downloads/release/python-31011/ and make sure to check the box for 'add python to enviromnent variables' during installation. Note: For Python 3.4 or later, pip is included by default
