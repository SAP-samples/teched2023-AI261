...
## Step 8: By clicking the distribution curve (1), the user opens a section with a drop-down menu and via the drop-down menu the user can select a normal or a uniform distribution curve
